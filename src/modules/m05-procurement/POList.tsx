        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              {['PO Number', 'Supplier', 'Date', 'Deliver To', 'Products', 'Value', 'Status', ''].map(h => (
            ...
            {pos.map(po => {
              ...
              return (
                <>
                  ...
                  >
                    <td className="px-4 py-3 font-mono text-xs text-gray-700 whitespace-nowrap">{po.poNo}</td>
                    <td className="px-4 py-3 text-xs text-gray-700 whitespace-nowrap max-w-[180px] truncate">
                      {po.supplierName}
                    </td>
                    <td className="px-4 py-3 text-xs text-gray-500 whitespace-nowrap">{fmtDate(po.date)}</td>
                    <td className="px-4 py-3 text-xs text-gray-500 whitespace-nowrap">
                      {po.storeName.replace('Bharat Agri Store – ', '')}
                    </td>
                    <td className="px-4 py-3 text-xs text-gray-600 whitespace-nowrap">
                      {po.lines.length} item{po.lines.length !== 1 ? 's' : ''}
                    </td>
                    <td className="px-4 py-3 text-xs font-semibold text-gray-800 font-mono whitespace-nowrap">
                      ₹{fmt(po.totalAmt)}
                    </td>
